...
class Sha512 {
    ...
    static hash(msg, options) {
        ...
        console.log(M[0].map(i => BigInt(i.toString())))
        ...
        for (let i=0; i<N; i++) {
            ...
            for (let t=0;  t<16; t++) {
                W[t] = M[i][t];
                console.log(W[t].toString(16));
            }
            for (let t=16; t<80; t++) {

                // console.log('w15',W[t-15].toString(16))
                // console.log('w2',W[t-2].toString(16))
                // console.log('s0',Sha512.σ0(W[t-15]).toString(16))
                // console.log('s1',Sha512.σ0(W[t-2]).toString(16))
                // console.log('s0',BitInt(Sha512.σ0(W[t-15]).toString(16)).toString(16))
                // console.log('s1',BitInt(Sha512.σ0(W[t-2]).toString(16)).toString(16))
                W[t] = (Sha512.σ1(W[t-2]).add(W[t-7]).add(Sha512.σ0(W[t-15])).add(W[t-16]));
                // console.log(t, 'wt', W[t].toString(16))
            }
            ...
            for (let t=0; t<80; t++) {
                // console.log('e14',Sha512.ROTR(e, 14).toString())
                // console.log('a28',Sha512.ROTR(a, 28).toString())
